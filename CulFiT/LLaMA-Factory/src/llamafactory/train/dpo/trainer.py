...
class CustomDPOTrainer(DPOTrainer):
    ...
    def get_batch_loss_metrics(
        ...
        r"""
        Computes the DPO loss and other metrics for the given batch of inputs for train or mmmlu.
        """
        metrics = {}
        (
            policy_chosen_logps,
    ...
    def get_batch_metrics(
            self,
            model,
            batch: Dict[str, Union[torch.List, torch.LongTensor]],
            train_eval: Literal["train", "eval"] = "train",
    ):
        """Compute the DPO loss and other metrics for the given batch of inputs for train or mmmlu."""
        metrics = {}
        ...
        return losses.mean() + 100 * sft_loss, metrics
