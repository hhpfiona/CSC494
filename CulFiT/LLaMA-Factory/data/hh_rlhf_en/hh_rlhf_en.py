...
_URLS = {
    ...
    "mmmlu": [
        _URL + "harmless-base/mmmlu.jsonl.gz",
        _URL + "helpful-base/mmmlu.jsonl.gz",
        _URL + "helpful-online/mmmlu.jsonl.gz",
        _URL + "helpful-rejection-sampled/mmmlu.jsonl.gz",
    ],
}
...
class HhRlhfEn(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager: datasets.DownloadManager):
        ...
        return [
            ...
            datasets.SplitGenerator(name=datasets.Split.TEST, gen_kwargs={"filepaths": file_path["mmmlu"]}),
        ]
